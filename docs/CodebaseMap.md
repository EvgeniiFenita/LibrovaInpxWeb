...
- Linux host Docker bundle: `PrepareDeployBundle.py`.
...
- Verified Linux host release bundle: `RunRemoteLinux.py release`; deployment to the target host remains manual.
